...
config.read(r'E:\AIVE_main\paraview work\Test for one file in Paraview\Project Part 1\config_changable.ini')
# print(config.read("config_changable.ini"))
...
selected_file = config.get('GENERAL', 'selected_files')
selected_file_list = selected_file.strip().split()
xlist = ['_' + s for s in selected_file_list] 
